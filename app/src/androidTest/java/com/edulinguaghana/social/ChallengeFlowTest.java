...
public class ChallengeFlowTest {
    ...
    @Test
    public void challengeFriend_buttonCreatesChallenge() throws Exception {
        ...
        try (ActivityScenario<ProfileActivity> sc = ActivityScenario.launch(intent)) {
            // Click Challenge
            onView(withId(com.edulinguaghana.R.id.btnChallengeFriend)).perform(click());
            ...
            assertNotNull(repo);
            assertEquals(1, repo.getChallengesForUser("userA").size());
        }
    }
}
