...
### Download
The official app is available as a signed APK. You can download it directly from our [Landing Page](https://ibrahimsaani.github.io/EduLinguaGhana/) or the [GitHub Releases](https://github.com/IbrahimSaani/EduLinguaGhana/releases) page.

### Installation
1.  Download the `app-release.apk`.
2.  Open the file on your Android device.
3.  Enable "Install from Unknown Sources" if prompted by your browser or system.
...
*   **Language:** Java
*   **UI Framework:** Android Material Components (XML)
